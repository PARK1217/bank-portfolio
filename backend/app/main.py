...
from .api.admin_chatbot import router as admin_chatbot_router
...
api.include_router(admin_chatbot_router)
...
api.include_router(admin_observability_router)
